...
public class DPJoinPlanner implements Planner {
    ...
    private PlanNode makeLeafPlan(FromClause fromClause,
        ...
        // TODO:  IMPLEMENT
        //
        //     If you apply any conjuncts in the plan you generate, e.g. a
        //     predicate on a file-scan, or if an outer-join's subplan uses
        //     any conjuncts, these must be added to the leafConjuncts
        //     out-parameter.
        //
        //     Plans generated by this method must be prepared before being
        //     returned.  In addition, if a plan is changed after being
        //     prepared (e.g. by adding a predicate to the plan), it must be
        //     prepared again to ensure that costing estimates properly
        //     reflect the changes.
